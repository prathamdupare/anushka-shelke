...
import { SiAmazonaws, SiAngular, SiOpencv, SiR } from "react-icons/si";
...
export const Icons = {
  ...
  opencv: SiOpencv,
  nlp: TbBrain,
  ai: TbBrain, // Replacing with TbBrain
  generativeAI: TbBrain, // Replacing with TbBrain
  dataVisualization: MdDataExploration,
  descriptiveAnalysis: SiScikitlearn,
  probabilityTheory: FaDatabase,
  statisticalAnalysis: SiScikitlearn,
  r: SiR,
  stata: SiNeo4J,
  neo4j: SiNeo4J,
  cloud: FaCloud,
